...
const glm::vec3 & Ray3D::origin() const { return m_origin; }

const glm::vec3 & Ray3D::direction() const { return m_direction; }

void Ray3D::setOrigin(const glm::vec3 & origin) { m_origin = origin; }
...
void Ray3D::normalize() { m_direction = glm::normalize(m_direction); }

glm::vec3 Ray3D::at(float s) const { return m_origin + s * m_direction; }
}


std::ostream & operator<<(std::ostream & os, const deliberation::Ray3D & r)
{
