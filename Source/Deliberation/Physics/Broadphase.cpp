...
{
Broadphase::Broadphase(Narrowphase & narrowphase) : m_narrowphase(narrowphase)
{
}
...
Broadphase::createProxy(const CollisionObject & collisionObject)
{
    auto proxy = std::make_shared<BroadphaseProxy>(
        (void *)&collisionObject, collisionObject.bounds());
