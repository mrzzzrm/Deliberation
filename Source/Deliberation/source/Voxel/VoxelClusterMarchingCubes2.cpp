...
VoxelClusterMarchingCubes2::VoxelClusterMarchingCubes2(const VoxelClusterMarchingCubesTriangulation & triangulation,
...
void VoxelClusterMarchingCubes2::run()
{
...
LayoutedBlob && VoxelClusterMarchingCubes2::takeVertices()
{
    return std::move(m_vertices);
}

bool VoxelClusterMarchingCubes2::checkVoxel(i32 x, i32 y, i32 z) const
{
    auto &size = m_cluster.size();
...
void VoxelClusterMarchingCubes2::generateMesh(i32 x, i32 y, i32 z, u8 configID)
{
    ...
    for (auto & triangle : mesh)
    {
        ...
        {
            (*m_positions)[vertexIndex] = triangle.positions[i] + glm::vec3(x, y, z);
...
glm::vec3 VoxelClusterMarchingCubes2::getCubeColorAtCorner(i32 x, i32 y, i32 z, u8 corner) const
{
