...
gl::GLint GLSLSizeOf(gl::GLenum type)
{
    ...
    */
    ...
    case gl::GL_RGBA16_SNORM:       return 4 * 2; // TODO: Verify
    case gl::GL_RGBA8_SNORM:        return 4 * 1; // TODO: Verify
    case gl::GL_RGB32F:             return 3 * 4;
    case gl::GL_RGB32I:             return 3 * 4;
    case gl::GL_RGB32UI:            return 3 * 4;
    case gl::GL_RGB16_SNORM:        return 3 * 4; // TODO: Verify
    case gl::GL_RGB16F:             return 3 * 2;
    case gl::GL_RGB16:              return 3 * 2;
    case gl::GL_RGB8_SNORM:         return 3 * 1; // TODO: Verify
    case gl::GL_RGB8:               return 3 * 1;
    case gl::GL_RGB8I:              return 3 * 1;
    case gl::GL_RGB8UI:             return 3 * 1;
    case gl::GL_RGB9_E5:            return 3;
    case gl::GL_RG16_SNORM:         return 2 * 2; // TODO: Verify
    case gl::GL_RG8_SNORM:          return 2 * 1; // TODO: Verify
    case gl::GL_R16_SNORM:          return 1 * 2; // TODO: Verify
    case gl::GL_R8_SNORM:           return 1 * 1; // TODO: Verify
    case gl::GL_DEPTH_COMPONENT32F: return 1 * 4;
    case gl::GL_DEPTH_COMPONENT24:  return 1 * 3;
    case gl::GL_DEPTH_COMPONENT16:  return 1 * 2;
    case gl::GL_DEPTH32F_STENCIL8:  return 4 + 1; // TODO: Verify
    case gl::GL_DEPTH24_STENCIL8:   return 3 + 1; // TODO: Verify
