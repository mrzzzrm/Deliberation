...
ComponentSubscriptions<ComponentType, Subscriptions...> & ComponentSubscriptions<ComponentType, Subscriptions...>::instance()
{
...
template<typename ComponentType, typename ... Subscriptions>
ComponentSubscriptions<ComponentType, Subscriptions...>::ComponentSubscriptions()
{
    Swallow((registerDispatch<Subscriptions>(), 0)...);
}

template<typename ComponentType, typename ... Subscriptions>
void ComponentSubscriptions<ComponentType, Subscriptions...>::dispatch(ComponentBase & componentBase,
