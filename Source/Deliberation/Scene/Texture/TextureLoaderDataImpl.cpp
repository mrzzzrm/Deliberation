...
TextureBinary TextureLoaderDataImpl::load()
{
    ...
    //        if (r == IL_FALSE)
    //        {
    //            Fail(std::string("Failed to load texture: ") +
    //            iluErrorString(ilGetError())); return TextureBinary();
    //        }
    ...
    //        ilCopyPixels(0u, 0u, 0u, width, height, 1, IL_RGB, IL_FLOAT,
    //        pixels.data());

    //        ilDeleteImage(ilName);
    //    }

    //    return TextureBinary(SurfaceBinary(std::move(pixels), width, height,
