    ...
    const glm::vec3 & origin, const glm::vec3 & delta)
{
    ...
    transform.setPosition(
        m_origin + m_delta -
        glm::normalize(m_delta) * DebugGeometryManager::ARROW_CONE_HEIGHT);
...
bool DebugGeometryRenderer::visible() const { return m_visible; }
...
void DebugGeometryRenderer::setVisible(bool visible) { m_visible = visible; }

DebugBoxInstance & DebugGeometryRenderer::addBox(
...
DebugPointInstance & DebugGeometryRenderer::addPoint(
...
DebugArrowInstance & DebugGeometryRenderer::addArrow(
...
DebugGeometryRenderer::addWireframe(const glm::vec3 & color, size_t index)
{
...
DebugSphereInstance & DebugGeometryRenderer::addSphere(
...
DebugPoseInstance &
DebugGeometryRenderer::addPose(const Pose3D & pose, size_t index)
{
